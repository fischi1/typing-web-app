...
const LevelProgressionDisplay: FC<Props> = ({
    username,
    lvl,
    curXP,
    nextLvlXP,
    ...
    return (
        <div className={clsx(classes.container, className)}>
            <div className={classes.usernameLvlContainer}>
                ...
                <Typography className={clsx(classes.level, classes.subText)}>
                    Lvl{lvl}
                </Typography>
            </div>
            <div className={classes.progressbarContainer}>
                <div
                    ...
                    style={{
                        width: `${calculatePercentXPBar(curXP, nextLvlXP)}%`
                    }}
                />
                <div
                    className={classes.progressEmpty}
                    style={{ flex: "1 0 auto" }}
                />
            </div>
            <div className={classes.progressionTextContainer}>
                <Typography
                    className={clsx(classes.subText, classes.progressText)}
                >
                    {curXP}/{nextLvlXP}
                </Typography>
            </div>
