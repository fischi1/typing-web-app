...
const CustomTooltip: FC<TooltipProps> = props => {
    ...
    return (
        ...
        >
            <Typography style={{ color: highlightColors.blue }} variant="h6">
                {dateNumberToDateStr(+payload.dayDate)}
            </Typography>
                ...
                >
                    <XAxis
                        ...
                        domain={
                            mappedData.length > 0
                                ? [
                                      mappedData[0].dayDate,
                                      mappedData[mappedData.length - 1].dayDate
                                  ]
                                : ["auto", "auto"]
                        }
                    ...
                    />
                    <YAxis stroke={highlightColors.white} />
