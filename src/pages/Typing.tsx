...
import useCatchBackspace from "../hooks/useCatchBackspace";
...
const Typing: FC<{}> = () => {
    ...
    const foundLesson = useMemo(() => getLesson(routeParams.uuid), [
        routeParams.uuid
    ]);
    ...
    var dialogText = (
        <Typography align="center" variant="h5">
            Spend {foundLesson.lesson.gemCost} <DiamondIcon width={28} /> to
            start this lesson?
        </Typography>
    );
    ...
    if (notEnoughGems)
        dialogText = (
            <Typography align="center" variant="h5" color="error">
                You don't have enough <DiamondIcon width={28} /> for this lesson
                <br />
                You need {foundLesson.lesson.gemCost - userInfoState.gems}{" "}
                more...
            </Typography>
        );
    ...
    return (
        <>
            ...
            >
                {isTyping ? (
                    <TypingCanvas lesson={foundLesson.lesson} />
                ) : (
                    <Grid
                        container
                        justify="center"
