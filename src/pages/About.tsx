        ...
        <Grid container justify="center" alignItems="center" style={{height: `calc(100vh - ${appbarHeight})`}}> 
            <Container maxWidth="md" style={{textAlign: "center"}}>
                ...
                <Typography variant="h5">
                    Made by <span style={{color:highlightColors.blue}}>Lukas Fischer</span>
                </Typography>
                <div>&nbsp;</div>
                <Link
                    ...
                    target="_blank"
                >
                    <Typography><span style={{color: highlightColors.yellow}}>View on github</span></Typography>
                </Link>
                <div>&nbsp;</div>
                <Link
                    ...
                    target="_blank"
                >
                    <Typography><span style={{color: highlightColors.yellow}}>https://lukasfischer.me</span></Typography>
                </Link>
